...
ImagePopover = (function(superClass) {
  ...
  ImagePopover.prototype.render = function() {
    ...
    //   };
    // })(this));
    this.srcEl.on('change', (function(_this) {
      return function(e) {
          var reader = new FileReader();
          console.log(_this.srcEl);
          reader.readAsDataURL(_this.srcEl[0].files[0]);//发起异步请求
          reader.onload = function(){
              //读取完成后，将结果赋值给img的src
              var select = document.querySelector('.selected');
              select.src = this.result;
          };
      };
    })(this));
